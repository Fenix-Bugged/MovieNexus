...
export class FavoritesService {
  ...
  // Nuestra "fuente de la verdad" reactiva utilizando Signals
  ...
  private loadFavorites(): void {
    // IMPORTANTE: Solo leemos LocalStorage si estamos ejecutándonos en el navegador
  ...
  toggleFavorite(movie: Movie): void {
    ...
    // Guardamos en disco (LocalStorage) validando el entorno seguro
    if (isPlatformBrowser(this.platformId)) {
